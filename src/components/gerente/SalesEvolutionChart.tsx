...
const SalesEvolutionChartComponent = React.forwardRef<HTMLDivElement, SalesEvolutionChartProps>(
...
SalesEvolutionChartComponent.displayName = "SalesEvolutionChart";

export const SalesEvolutionChart = SalesEvolutionChartComponent;
